                ...
                <div className=" w-[400px] bg-gray-800 py-2 px-4 relative rounded-2xl">
                  ...
                  <div className="pt-20 text-center">
                    ...
                    <div className="flex items-center justify-center text-[28px] my-6 gap-5">
                      ...
                      <a href={Github} target="_blank"><AiOutlineGithub className="cursor-pointer hover:text-cyan-400 hover:scale-140 duration-300" /></a>
                    </div>
                    <a href= {Portfolio} target="_blank"><div className="flex gap-3 items-center justify-center my-3 bg-gray-900 rounded-full py-3 cursor-pointer hover:bg-cyan-600 duration-300">
